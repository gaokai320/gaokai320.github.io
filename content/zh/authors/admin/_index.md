...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:gaokai19@pku.edu.cn'
  - icon: twitter
    icon_pack: fab
    link: https://twitter.com/Kyle26758769
    label: Follow me on Twitter
    display:
      header: false
  - icon: google-scholar # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: ai
    link: https://scholar.google.com/citations?user=IDMLTHMAAAAJ
  - icon: github
    icon_pack: fab
    link: https://github.com/gaokai320
  # - icon: linkedin
  #   icon_pack: fab
